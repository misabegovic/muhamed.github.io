...
source: "Paul Battley / po-ru.com"
url_external: "https://po-ru.com/2026/07/29/it-doesnt-matter-whether-matz-is-nice"
type: note
date: 2026-07-29
created_at: 2026-07-29T12:00:00+02:00
tags: [ruby, rails, community, governance, dhh, shopify, open-source]
---

[Paul Battley](https://po-ru.com/) — the same Paul I recently talked cathedrals, Go, and 11 factors with — published a piece arguing that MINASWAN ("Matz is nice and so we are nice") was only ever projection. Matz is quiet, reserved, and mostly online in Japanese; that leaves a blank surface to project niceness onto. Meanwhile, Paul argues, the community's actual power centers don't pass the test.
...
This lands right next to my own open question — [is Ruby dead, and is it time to build cathedrals in Go?](/brain/is-ruby-dead-cathedrals-in-go/) Paul already moved: his answer to the governance problem wasn't a fork, it was a different language and his own [11 factors](https://11factor.org/). My framing was technical — cost, speed, guard rails. His is about who holds the project. Both point the same way: the biggest risk in a framework isn't performance, it's who controls it.
