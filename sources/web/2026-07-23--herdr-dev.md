...
summary: Herdr.dev - tool or project to look into
---
            ...
            <nav class="nav" aria-label="Primary navigation">
                ...
                <div class="nav-tools">
                    <a class="nav-icon-link has-count" href="https://github.com/ogulcancelik/herdr" aria-label="Herdr on GitHub">
                        ...
                        <span class="nav-star-count" data-stat-stars></span>
                    </a>
        ...
        <main>
            <section class="hero" id="hero">
                <div class="hero-left">
                    ...
                    <div class="install-panel" aria-label="Install options">
                        ...
                        <div class="windows-install" aria-label="Windows beta preview install">
                            <div class="windows-install-heading">
                                ...
                                <a href="/docs/preview/windows-beta/">Next docs</a>
                            </div>
                    ...
                    <p class="hero-note">Stable Linux/macOS · Windows preview beta · no Electron, no account, no telemetry · <a href="/stats/">live stats</a></p>
                </div>
                </div>
...
▝▜█████▛▘
  ▘▘ ▝▝</pre>
                                            <div class="cc-header-text">
                                                <div><b>Claude Code</b> <span class="dim">v2.1.198</span></div>
                                                <div class="dim">Fable 5 with high effort · Claude Max</div>
                                                <div class="dim">~/Projects/llm-proxy</div>
                                            </div>
                                        </div>
                                        <br />
...
$ herdr</code></pre>
            ...
            <section class="section marketplace-teaser" id="marketplace">
                <div class="marketplace-teaser-top">
                    <div class="marketplace-teaser-copy">
                        <p class="section-kicker"># marketplace</p>
                        <h2>Make it yours.</h2>
                        <p class="marketplace-teaser-lede">
                            Review diffs beside the agent. Approve from your phone.
                            Navigate like vim. Watch your agents graze as pixel-art
                            sheep. If herdr doesn't do it, one of
                            <span data-plugin-count>150+</span> community plugins
                            does, or you publish your own with one GitHub topic.
                        </p>
                        <div class="hero-actions">
                    ...
                    <div class="marketplace-teaser-install">
                        <div class="install-card" aria-label="Plugin install command">
                            <span class="prompt">$</span>
                            <code>herdr plugin install &lt;owner&gt;/&lt;repo&gt;</code>
                        </div>
                        <p class="marketplace-install-output"># any public repo tagged herdr-plugin</p>
                        <p class="marketplace-install-note">
                            <span data-plugin-count>150+</span> community plugins, auto-discovered from GitHub
                        </p>
                    </div>
                </div>
                <div class="marketplace-teaser-grid">
                    <a class="mp-chip" href="https://github.com/smarzban/herdr-file-viewer" target="_blank" rel="noopener" data-repo="smarzban/herdr-file-viewer">
                        <span class="mp-chip-name">smarzban/<b>herdr-file-viewer</b></span>
                        <span class="mp-chip-desc">Git-aware file tree, diffs, and rendered markdown in a side pane.</span>
                        <span class="mp-chip-meta">Rust</span>
                    </a>
                    <a class="mp-chip" href="https://github.com/persiyanov/herdr-reviewr" target="_blank" rel="noopener" data-repo="persiyanov/herdr-reviewr">
                        <span class="mp-chip-name">persiyanov/<b>herdr-reviewr</b></span>
                        <span class="mp-chip-desc">Review the agent's diff, comment on lines, send notes back to its prompt.</span>
                        <span class="mp-chip-meta">Rust</span>
                    </a>
                    <a class="mp-chip" href="https://github.com/paulbkim-dev/vim-herdr-navigation" target="_blank" rel="noopener" data-repo="paulbkim-dev/vim-herdr-navigation">
                        <span class="mp-chip-name">paulbkim-dev/<b>vim-herdr-navigation</b></span>
                        <span class="mp-chip-desc">Ctrl+h/j/k/l moves seamlessly across herdr panes and vim splits.</span>
                        <span class="mp-chip-meta">Shell</span>
                    </a>
                    <a class="mp-chip" href="https://github.com/yuk1ty/herdr-spreader" target="_blank" rel="noopener" data-repo="yuk1ty/herdr-spreader">
                        <span class="mp-chip-name">yuk1ty/<b>herdr-spreader</b></span>
                        <span class="mp-chip-desc">Whole workspace layouts, tabs, panes and commands, from one YAML file.</span>
                        <span class="mp-chip-meta">Rust</span>
                    </a>
                    <a class="mp-chip" href="https://github.com/AltanS/collie" target="_blank" rel="noopener" data-repo="AltanS/collie">
                        <span class="mp-chip-name">AltanS/<b>collie</b></span>
                        <span class="mp-chip-desc">A phone PWA for your herd over Tailscale, with push when an agent needs you.</span>
                        <span class="mp-chip-meta">TypeScript</span>
                    </a>
                    <a class="mp-chip" href="https://github.com/ragamo/herdr-flock" target="_blank" rel="noopener" data-repo="ragamo/herdr-flock">
                        <span class="mp-chip-name">ragamo/<b>herdr-flock</b></span>
                        <span class="mp-chip-desc">Your agents as pixel-art sheep on a farm. Ended sessions rest in the graveyard.</span>
                        <span class="mp-chip-meta">Rust</span>
                    </a>
                </div>
            </section>
...
<span class="cmd">herdr</span> pane read <span class="str">1-2</span> <span class="flag">--source</span> <span class="str">recent-unwrapped</span></code></pre>
        ...
        <footer class="footer">
            ...
            <div>
                ...
                <a href="https://github.com/ogulcancelik/herdr/releases"
                    >Releases</a
                >
                <a href="/cdn-cgi/l/email-protection#d8b0bda198b0bdaabcaaf6bcbdae"><span class="__cf_email__" data-cfemail="ed858894ad85889f899fc389889b">[email&#160;protected]</span></a>
            </div>
        ...
        <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>
            (function () {
                fetch("https://assets.herdr.dev/plugins/index.json")
                    .then(function (res) {
                        return res.ok ? res.json() : null;
                    })
                    .then(function (data) {
                        if (!data || !Array.isArray(data.plugins)) return;
                        document.querySelectorAll("[data-plugin-count]").forEach(function (el) {
                            el.textContent = String(data.plugins.length);
                        });
                        var byName = {};
                        data.plugins.forEach(function (p) {
                            byName[p.fullName] = p;
                        });
                        document.querySelectorAll(".mp-chip[data-repo]").forEach(function (chip) {
                            var p = byName[chip.getAttribute("data-repo")];
                            if (!p || typeof p.stars !== "number") return;
                            var meta = chip.querySelector(".mp-chip-meta");
                            if (meta) meta.textContent = "★ " + p.stars + " · " + meta.textContent;
                        });
                    })
                    .catch(function () {});

                fetch("https://assets.herdr.dev/stats/stats.json")
                    .then(function (res) {
                        return res.ok ? res.json() : null;
                    })
                    .then(function (data) {
                        var stars = data && data.stars && data.stars.total;
                        if (typeof stars !== "number") return;
                        var compact =
                            stars >= 1000
                                ? (stars / 1000).toFixed(1).replace(/\.0$/, "") + "k"
                                : String(stars);
                        document.querySelectorAll("[data-stat-stars]").forEach(function (el) {
